...
def image_upload_path(instance, filename, flag):
    if flag == 0:
        return f"media/property_pics/{instance.property.user.username}/{filename}"
    else:
        return f"media/profile_pics/{instance.user.username}_profile_pic"
    
class Profile(models.Model):
    user = models.OneToOneField(User, on_delete=models.CASCADE)
    image = models.ImageField(help_text='Choose your profile-picture', default='media/default_for_profile.jpg', upload_to= partial(image_upload_path, flag=1))
...
class Image(models.Model):
    ...
    image = models.ImageField(default='media/default_for_property,jpg', upload_to= partial(image_upload_path, flag=0))
