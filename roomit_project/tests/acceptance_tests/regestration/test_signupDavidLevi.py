...
class TestSignupDavidLevi(TestCase):
    def setUp(self):
    ...
    def test_signupDavidLevi(self):
        ...
        self.driver.find_element(By.ID, "id_username").send_keys("Mor")
        self.driver.find_element(By.ID, "id_email").send_keys("mor@gmail.com")
        ...
        self.driver.find_element(By.ID, "id_first_name").send_keys("Mor")
