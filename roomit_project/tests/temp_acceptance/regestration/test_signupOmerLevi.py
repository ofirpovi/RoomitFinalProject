...
class TestSignupOmerLevi():
  ...
  def test_signupOmerLevi(self):
    ...
    self.driver.find_element(By.ID, "id_username").send_keys("Omer")
    self.driver.find_element(By.ID, "id_email").send_keys("omer@gmail.com")
    ...
    self.driver.find_element(By.ID, "id_first_name").send_keys("Omer")
