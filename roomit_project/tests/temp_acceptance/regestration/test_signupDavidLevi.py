...
class TestSignupDavidLevi():
  ...
  def test_signupDavidLevi(self):
    ...
    self.driver.find_element(By.ID, "id_username").send_keys("David")
    self.driver.find_element(By.ID, "id_email").send_keys("david@gmail.com")
    ...
    self.driver.find_element(By.ID, "id_first_name").send_keys("David")
